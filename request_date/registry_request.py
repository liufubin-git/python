...
class RegistryRequestDate(object):
    # def __init__(self):
    #     self.registry_request_body = {     # 用户注册请求参数
    ...
    #                 "verifiedStatus": 0
    #         }
    #     self.registry_request_url = "http://192.168.1.37:8080/momapi/v1/system/userMgt/registerUser"  # 用户注册url
    #     self.registry_request_header = {"Content-Type": "application/json"}
