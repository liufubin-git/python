...
def readtext(filepath):
    ...
    return content
#120.77.57.67
filepath="E://01_api//Historical_Industry_Exposure.txt"
path="E://01_api//Historical_Industry_Exposure_1.txt"

url="http://120.77.57.67:8080/dataservice/v1/secuirties/HF00000008%2CHF0000000G/historical-industry-style-exposure?startDate=2017-01-01&endDate=2017-04-10"
data=get_api(url)
