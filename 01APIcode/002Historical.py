...
def ip_url(ip):
    url="http://%s:8080/dataservice/v1/secuirties/HF00000008%2CHF0000000G/historical-return?frequency=Annually&startDate=2010-01-01&endDate=2017-04-10"%ip
    return url
...
def readtext(filepath):
    ...
    return content
#120.77.57.67
filepath="E://01_api//historical.txt"
path="E://01_api//historical_1.txt"

url="http://120.77.57.67:8080/dataservice/v1/secuirties/HF00000008%2CHF0000000G/historical-return?frequency=Annually&startDate=2010-01-01&endDate=2017-04-10"
data=get_api(url)
...
for i in range (0,len(date)):
    content="%s%s%s"%(date[i],value_HF00000008[i],value_HF0000000G[i])
