...
def readtext(filepath):
    ...
    return content
#120.77.57.67
filepath="E://01_api//trailing.txt"
path="E://01_api//trailing_1.txt"

url="http://120.77.57.67:8080/dataservice/v1/secuirties/HF0000000G%2CHF00000008/trailing-return?endDate=2017-05-01"
data=get_api(url)
...
value_HF0000000G=data.get("data").get("dataset")[0]
value_HF0000000G=value_HF0000000G["values"]
i=0
for i in range (0,len(date)):
    content="%s%s"%(date[i],value_HF0000000G[i])
