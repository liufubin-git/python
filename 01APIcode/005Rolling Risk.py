...
def readtext(filepath):
    ...
    return content
#120.77.57.67
filepath="E://01_api//Rolling_Risk.txt"
path="E://01_api//Rolling_Risk_1.txt"

url="http://120.77.57.67:8080/dataservice/v1/secuirties/HF00000008%2CHF0000000G/rolling-drawdown?frequency=Annually&startDate=2010-01-01&endDate=2017-01-01"
data=get_api(url)
