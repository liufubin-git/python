...
def readtext(filepath):
    ...
    return content
#120.77.57.67
filepath="E://01_api//Asset_Exposure.txt"
path="E://01_api//Asset_Exposure_1.txt"

url="http://120.77.57.67:8080/dataservice/v1/secuirties/HF00002DVS_HF00000A84/asset-style-exposure?endDate=2017-05-01&index=MultiAsset"
data=get_api(url)
