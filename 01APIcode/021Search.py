...
def readtext(filepath):
    ...
    return content
#120.77.57.67
filepath="E://01_api//Search.txt"
path="E://01_api//Search_1.txt"

url="http://120.77.57.67:8080/dataservice/v1/secuirties/search?api-user-id=208564&key=%E6%B2%AA%E6%B7%B1"
data=get_api(url)
