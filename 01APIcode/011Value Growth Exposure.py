...
def readtext(filepath):
    ...
    return content
#120.77.57.67
filepath="E://01_api//Value_Growth_Exposure.txt"
path="E://01_api//Value_Growth_Exposure_1.txt"

url="http://120.77.57.67:8080/dataservice/v1/secuirties/HF00000008%2CHF0000000G/value-growth-style-exposure?endDate=2017-04"
data=get_api(url)
...
for i in range (0,len(title)):
    content="%-20s%-20s%-20s%-20s%-20s%-20s%-20s%-20s%-20s%-20s%-20s"%(title[i],id1_HF00000008,alpha1_HF00000008,dType2_HF00000008,value1_HF00000008[i],value2_HF00000008[i],id4_HF0000000G,alpha4_HF0000000G,dType4_HF0000000G,value3_HF0000000G[i],value4_HF0000000G[i])
    # print content
