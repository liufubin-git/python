...
class RegistryRequest(unittest.TestCase):
    ...
    def test_normal_registry(self):
        ...
        get_session = RequestMethod.request_get_method('http://192.168.1.37:8080'  # 调获取code接口，会在redis中生成code码
                                                       '/momapi/v1/system/userMgt/getSmsCode?mobile=130{}&t={}'
...
if __name__ == '__main__':
    ...
    tset_suite = unittest.TestSuite()
    # print('555')
    # tset_suite.addTest(RegistryRequest("test_didnot_apply_code"))
    tset_suite.addTest(RegistryRequest("test_delete_user"))
    unittest.TextTestRunner().run(tset_suite)
